export const site = {
  ...
  title: "Joseph Bergin — Software Engineer",
  role: "Software Engineer",
  company: "JPMorgan Chase",
  current: "Software Engineer @ JPMorgan Chase",
  location: "McKinney, TX",
  headline:
    "Building AI systems, backend infrastructure, and products people actually use.",
  description:
    "Software Engineer at JPMorgan Chase building production RAG systems, OpenSearch vector infrastructure, and retrieval APIs. Previously co-founded Akoe, an LLM-powered QA platform.",
